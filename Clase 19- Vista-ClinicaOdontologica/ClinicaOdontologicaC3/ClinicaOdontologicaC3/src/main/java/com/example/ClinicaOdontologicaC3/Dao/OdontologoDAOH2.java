...
public class OdontologoDAOH2 implements iDao<Odontologo>{
    ...
    private static final String SQL_SELECT_DELETE="DELETE  FROM ODONTOLOGOS WHERE ID=?";
    ...
    public void eliminar(Integer id) {
        logger.warn("iniciando la operacion de eliminacion de un odontologo con ID: "+id);
        Connection connection= null;
        try{
            connection= BD.getConnection();
            PreparedStatement psDelete= connection.prepareStatement(SQL_SELECT_DELETE);
